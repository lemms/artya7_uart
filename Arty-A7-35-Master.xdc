...
set_property -dict { PACKAGE_PIN C9    IOSTANDARD LVCMOS33 } [get_ports { send_btn }]; #IO_L11P_T1_SRCC_16 Sch=btn[1]
...
## USB-UART Interface
set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVTTL} [get_ports uart_rxd_out]
set_property -dict {PACKAGE_PIN A9 IOSTANDARD LVTTL} [get_ports uart_txd_in]
